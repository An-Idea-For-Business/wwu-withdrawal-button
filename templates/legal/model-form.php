...
?>
<div class="wwu-wb-model-form">
	<h3><?php echo esc_html( $form['title'] ); ?></h3>
	<p class="wwu-wb-model-form__note"><em><?php echo esc_html( $form['note'] ); ?></em></p>
	<p><?php echo esc_html( $form['to'] ); ?></p>
	<p><?php echo esc_html( $form['body'] ); ?></p>
	<ul class="wwu-wb-model-form__fields">
	...
	<p class="wwu-wb-model-form__delete"><small><?php echo esc_html( $form['delete'] ); ?></small></p>
</div>
